        ...
        <div class="invoice-card" id="PrintMe">
            ...
            <div class="invoice-details">
                ...
                <div class="row-data">
                    ...
                    <div class="">
                        <h6 class="item-title"><?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo ((float)$ticket->paidamount) ?></h6>
                    </div>
                </div>
                ...
                <div class="row-data">
                    ...
                    <div class="">
                        <h6 class="item-title"><?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo (float)$due ?></h6>
                    </div>
                </div>
