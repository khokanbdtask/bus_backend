            ...
            <table class="table table-bordered" id="">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo ((float)$ticket->paidamount); ?>
                        </td>
                    </tr>
                    ...
                    <?php if ($ticket->payment_status != "paid") : ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo ((float)$ticket->paidamount - (float)$due); ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <?php echo  $sessiondata->get('currency_symbol'); ?> <?php echo  (float)$due; ?>
                            </td>
                        </tr>
